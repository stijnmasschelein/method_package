---
title: Create the regression tables
---
...
model1a <- feols(car_short ~ friday * top,
                 cluster = "anndat",
                 data = subset)
model2a <- feols(car_short ~ friday * top | (year + month + size_decile) : top,
                 cluster = "anndat",
                 data = subset)
model3a <- feols(car_short ~ friday * top | (year + month + size_decile + vol_decile) : top,
                 cluster = "anndat",
                 data = subset)
...
model1b <- feols(car_long ~ friday * top,
                 cluster = "anndat",
                 data = subset)
model2b <- feols(car_long ~ friday * top | (year + month + size_decile) : top,
                 cluster = "anndat",
                 data = subset)
model3b <- feols(car_long ~ friday * top | (year + month + size_decile + vol_decile) : top,
                 cluster = "anndat",
                 data = subset)
...
model2 <- feols(car_short ~ friday + friday : quantile
                | (year + month + size_decile) : quantile,
                cluster = "anndat",
                data = main_extra)
